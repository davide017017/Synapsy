...
class Kernel extends ConsoleKernel {
  ...
  protected function schedule(Schedule $schedule): void {
    ...
    $schedule->call(function () {
      $this->forEachUser(
        fn(User $user) => app(FinancialOverviewService::class)->snapshotDaily($user, now())
      );
    })->dailyAt('23:59');
    ...
    $schedule->call(function () {
      $this->forEachUser(
        fn(User $user) => app(FinancialOverviewService::class)->snapshotMonthly($user, now())
      );
    })->monthlyOn(1, '00:01');
    ...
    $schedule->call(function () {
      $this->forEachUser(
        fn(User $user) => app(FinancialOverviewService::class)->snapshotYearly($user, now())
      );
    ...
    $schedule->call(function () {
      $this->forEachUser(
        fn(User $user) => app(FinancialOverviewService::class)->snapshotCurrent($user)
      );
    })->dailyAt('00:15');
  }
