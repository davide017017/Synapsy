    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('categories.web.update', $category) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="entrata" @selected(old('type', $category->type) === 'entrata')>Entrata</option>
                            <option value="spesa" @selected(old('type', $category->type) === 'spesa')>Spesa</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-gray-300 dark:border-gray-600 mt-6">
                        ...
                        <button type="submit"
                            ...
                            💾 <span class="ml-2">Salva Modifica</span>
                        </button>
