// Simple MD5 implementation adapted from public domain code
// Provides a minimal synchronous md5 hash function used for gravatar URLs.
// The implementation is not optimised but avoids external dependencies.
